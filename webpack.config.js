    ...
    module: {
        rules:[
            ...
            },
            {
                ...
                exclude: /node_modules/, //Excluir la caprtea node_modules
                use: {
                    loader: 'babel-loader', // Loader para pasar nuestro JS moderno a JS más antiguo para todos los navegadores
                    options: {
